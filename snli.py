...
from dataset_changing_order import MyDataset
...
raw_train_dataset=MyDataset(128,tokenizer,"preprocessed_snli_train.txt")
raw_test_dataset=MyDataset(128,tokenizer,"preprocessed_snli_test.txt")
...
train_dataloader=DataLoader(raw_train_dataset,batch_size=16,shuffle=True,collate_fn=raw_train_dataset.collate_fn)
test_dataloader=DataLoader(raw_test_dataset,batch_size=16,shuffle=True,collate_fn=raw_test_dataset.collate_fn)
